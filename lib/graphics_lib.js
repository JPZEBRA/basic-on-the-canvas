...
/* Version 0.1.1 / Revised 2025.02.11     */
/* Author : K-ARAI                        */
...
function ONMOUSE(func) {

    gplib_mouse_call_back = func;
...
function gplib_init_mouse() {


    if(window.TouchEvent != undefined ) {
        gplib_canvas.ontouchstart = gplib_OnTouchStart;
        gplib_canvas.ontouchend   = gplib_OnTouchEnd;
    }

    gplib_canvas.onmousedown = gplib_OnMouseDown;
    gplib_canvas.onmousemove = gplib_OnMouseMove;
    gplib_canvas.onmouseup   = gplib_OnMouseUp;
    gplib_canvas.onmouseout  = gplib_OnMouseUp;
    gplib_canvas.onwheel     = gplib_OnWheel;

}

function gplib_OnMouseDown(e) {

    MOUSEK = e.button;
    MOUSEX = gplib_realX(e);
    MOUSEY = gplib_realY(e);
    MOUSEW = 0;
...
function gplib_MouseCallBack() {

    if(gplib_mouse_call_back == "") return;

    gplib_mouse_call_back();

    return;

}

function gplib_OnTouchStart(e) {

    gplib_OnMouseDown(e.touches[0]);

}

function gplib_OnTouchEnd(e) {

    gplib_OnMouseUp(e.touches[0]);

}

function gplib_realX(e) {
