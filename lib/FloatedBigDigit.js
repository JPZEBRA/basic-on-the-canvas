...
/****************************************************************************/
    ...
    this.lastBit = function() {
        ...
        if( floatedBigDigitCashedLB && floatedBigDigitCashedLB.N != this.N ) {
...
/****************************************************************************/
    ...
    this.Copy = function(V) {
        ...
        for(var i=0;i<=this.N+floatedBigDigit_F;i++) this.Val[i] = (i<=V.N+floatedBigDigit_F) ? V.Val[i] : 0;
...
/****************************************************************************/
    ...
    this.SetFull = function() {
        ...
        for(var i=0;i<this.N;i++) this.Val[i] = floatedBigDigit_unit - 1;
...
/****************************************************************************/
    ...
    this.Compare = function(V) {
        ...
        var max1 = V.shiftPoint;
        var min1 = max1 - (V.N+floatedBigDigit_F);

        var max2 = this.shiftPoint;
        var min2 = max2 - (this.N+floatedBigDigit_F);
...
/****************************************************************************/
    ...
    this.toString2 = function() {
        ...
        for(trim=str.length-1;trim>min;trim--) if(str[trim]!="0") break;
